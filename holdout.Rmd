...
DfOrigin <- read.csv("SportPolitics_holdout.csv")
...
holdout <- Dtm_NotSparsed_DataFrame[-trainIDs,]
...
predict(model_knn, data.frame(tweet = "RT @JayRadd78: @espn #MyDunkWouldBe 360 spin, dunk it, catch it with my feet, kick it to my hands and dunk it again. Re-dunk-ulous."))
